...
A Figura~\ref{fig:c4n1} mostra os atores (cliente, mec\^anico, atendente, gestor, administrador) e os sistemas externos (c\^ameras IP, Azure Blob Storage, gateways email/SMS/WhatsApp, ERP de pe\c{c}as, sistema de pagamento, NF-e). O sistema central concentra a l\'ogica de neg\'ocio e \'e o ponto \'unico de coordena\c{c}\~ao.
